...
namespace eval ::optrace {
  variable script "/tmp/tmp.K83zbiJcRw/out/FutilBuild.runs/impl_1/main.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir /tmp/tmp.K83zbiJcRw/out/FutilBuild.cache/wt [current_project]
  set_property parent.project_path /tmp/tmp.K83zbiJcRw/out/FutilBuild.xpr [current_project]
  set_property ip_output_repo /tmp/tmp.K83zbiJcRw/out/FutilBuild.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet /tmp/tmp.K83zbiJcRw/out/FutilBuild.runs/synth_1/main.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc /tmp/tmp.K83zbiJcRw/device.xdc
