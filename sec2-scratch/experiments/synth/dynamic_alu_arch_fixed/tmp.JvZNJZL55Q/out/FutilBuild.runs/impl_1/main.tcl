...
namespace eval ::optrace {
  variable script "/tmp/tmp.JvZNJZL55Q/out/FutilBuild.runs/impl_1/main.tcl"
...
OPTRACE "set parameters" START { }
  ...
  set_property ip_output_repo /tmp/tmp.JvZNJZL55Q/out/FutilBuild.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet /tmp/tmp.JvZNJZL55Q/out/FutilBuild.runs/synth_1/main.dcp
