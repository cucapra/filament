...
(fud e -s cocotb.data "$data" --to cocotb-out "$dir/harness.fil" -s calyx.flags ' -d canonicalize' -s filament.flags ' --show-models --discharge-separate --solver z3 --unsafe-skip-discharge' -q | \
